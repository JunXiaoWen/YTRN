...
def build_backbone(config, model_type):
    if model_type == "det" or model_type == "table":
        ...
        from  .rec_yi_backbone import YTRN
        from  .rec_yi_sequenceModule import sequenceModule
        from .distill_gru import DistillGRU
        from  .rec_yi_dblstm import DBLSTM
        from .rec_yi_glrn import GLRN
        from  .rec_yi_valid_backbone import VYTRN
        from .rec_yi_fcrn import FCRN
        from .rec_yi_tcrn import TCRN
        from .rec_yi_acrn import ACRN
        support_dict = [
            'MobileNetV1Enhance', 'MobileNetV3', 'ResNet', 'ResNetFPN', 'MTB',
            'ResNet31', 'ResNet45', 'ResNet_ASTER', 'MicroNet',
            'EfficientNetb3_PREN', 'SVTRNet', 'ViTSTR', 'ResNet32', 'ResNetRFL',
            'DenseNet', 'YTRN', 'DistillGRU', 'DBLSTM', 'GLRN' ,'VYTRN', 'FCRN', 'TCRN', 'ACRN'
        ]
    elif model_type == 'e2e':
