...
class EncoderWithRNN(nn.Layer):
    def __init__(self, in_channels, hidden_size):
        ...
        self.lstm = nn.GRU(
            in_channels, hidden_size, direction='bidirectional', num_layers=1, dropout=0.2)
        # self.rnn = nn.Sequential(
        #     BidirectionalLSTM(input_size=512, hidden_size=256, output_size=256, direction='bidirectional', dropout=0, with_linear=True),
        #     BidirectionalLSTM(input_size=256, hidden_size=256, output_size=1185, direction='bidirectional', dropout=0, with_linear=True)
        # )
