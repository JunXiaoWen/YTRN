...
class YiCollator(object):
    ...
    def __call__(self, batch):
        ...
        label_1 = [item[1] for item in batch]
        label_2 = [item[2] for item in batch]
        seq = [item[3] for item in batch]

        return [paddle.to_tensor(images, dtype="float32"), paddle.to_tensor(label_1, dtype="int32"),
                paddle.to_tensor(label_2, dtype="int32"), paddle.to_tensor(seq, dtype="float32")]
